...
Custom two-character entries you add to the RNA mass table (e.g., `fA`) are recognized as monomers in sequences, so you can extend the parser without code changes.
